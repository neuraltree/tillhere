      ...
      [
          ...
          trailing: Switch(
            ...
            onChanged: (value) {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(content: Text('Theme switching will be implemented')),
              );
            },
        ...
        _buildSettingsTile(
          ...
          onTap: () {
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(content: Text('Default filter selection will be implemented')),
            );
          },
        ),
      ],
        ...
        _buildSettingsTile(
          ...
          trailing: Switch(
            ...
            onChanged: (value) {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(content: Text('Notification settings will be implemented')),
              );
            },
            activeColor: AppColors.neonGreen,
          ),
        ...
        _buildSettingsTile(
          ...
          trailing: Switch(
            ...
            onChanged: (value) {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(content: Text('Weekly summary toggle will be implemented')),
              );
            },
            activeColor: AppColors.neonGreen,
          ),
      ...
      [
        _buildSettingsTile(
          ...
          trailing: Switch(
            ...
            onChanged: (value) {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(content: Text('Biometric lock will be implemented')),
              );
            },
            activeColor: AppColors.neonGreen,
          ),
        ...
        _buildSettingsTile(
          ...
          onTap: () {
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(content: Text('Data retention settings will be implemented')),
            );
          },
        ),
        _buildSettingsTile(
      ...
      [
        ...
        _buildSettingsTile(
          ...
          onTap: () {
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(content: Text('Support contact will be implemented')),
            );
          },
        ),
      ],
